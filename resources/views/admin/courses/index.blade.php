...
{{-- Suggested code may be subject to a license. Learn more: ~LicenseLog:2024548594. --}}
                ...
                @empty
                    <p class="text-center">
{{-- Suggested code may be subject to a license. Learn more: ~LicenseLog:2461174252. --}}
                        No courses found.
                    </p>
                @endforelse
